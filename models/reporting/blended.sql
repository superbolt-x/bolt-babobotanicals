...
paid_data as
    ...
    FROM
        -- campaign_id is cast to varchar in every branch: Google's is bigint while
        -- Meta's and OpenAI's are strings, and Redshift will not union the two.
...
ga4_data as
    ...
    -- those sessions join to openaiads_campaign_performance above. The 'cmpn_'
